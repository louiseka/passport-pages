        ...
        return `
                <div class="result-item">
                    ...
                    <div>
                        ...
                        <button data-add-button data-add-id="${country.fifa}"> I've been here! </button>
...
function renderJournalModal(countryData) {
    ...
    <fieldset class="star-rating"> 
        <legend> Rate Affordability </legend>
         ...
         <input type="radio" id="cost1" name="cost-rating" value="1" />
    ...
    <fieldset class="star-rating"> 
        <legend> Rate Food </legend>
         ...
         <input type="radio" id="food1" name="food-rating" value="1" />
        ...
        <input type="radio" id="food5" name="food-rating" value="5" />
            <label for="food5">5<i class="fa-solid fa-utensils"></i> </label>     
    </fieldset>

    <fieldset class="star-rating"> 
        <legend> Rate Sightseeing </legend>

            <input type="radio" id="sight1" name="sights-rating" value="1" />
    ...
    <fieldset class="star-rating"> 
        <legend>Enjoyment</legend>
          ...
          <input type="radio" id="joy1" name="joy-rating" value="1" />
        ...
        <label> Youyr favourite memories from the trip</label>
        <input type="text" name="fav-memories" />
<button type="submit">Add entry to my Passport </button>
    </form>
    `
